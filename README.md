...
NaturalSIM je stále aktivní, raný prototyp.

Základní simulační jádro a řada jednotlivých systémů (generátor mapy, pohyb, stavba infrastruktury) již fungují a jsou vzájemně propojené. Hratelnost jako taková je zatím minimální a systémy mají k dokonalosti daleko – osady občas mizí a zvířata se chovají nevyzpytatelně.

I přes tento "work-in-progress" stav ale simulace dokázala běžet v extrémně zrychleném čase přes 1000 herních let bez pádu. Z časosběru je už jasně patrné, jak se příroda a svět plynule mění – například když geologické změny vytvoří záliv a lidská AI si na jeho břehu následně sama založí osadu.
